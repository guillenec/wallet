      ...
      <section className='flex sm:flex-row justify-center items-center w-full h-auto gap-5 flex-wrap box-border pt-3'>
        ...
        <div className='w-full md:w-[450px] lg:w-[550px] xl:max-w-[600px] flex sm:flex-row justify-center items-center h-auto gap-2 flex-wrap box-border'>
          <section className='relative flex w-[90%] sm:w-[200px] md:w-[200px] lg:w-[250px] xl:w-[300px] flex-col items-start justify-center p-3 rounded-md'>
                ...
                editUsername
                  ? (
                    <input
                      ...
                      className='contenido font-parrafo w-full bg-colorFuente1Submenu rounded-md p-1 border-none outline-none text-colorFuente2Submenu mb-1'
                    />
                    )
                  : (
            ...
            <span className='subrrayado w-full h-[3px] bg-hoverBotonSubmenu rounded-md' />
                  ...
                  ? (
                    <>
                      <input
                        ...
                        className='contenido font-parrafo w-full bg-colorFuente1Submenu rounded-md p-1 border-none outline-none text-colorFuente2Submenu mb-1 relative'
                      />

                      <span
                        className='cursor-pointer bg-fondo rounded-[4px] p-[1px] absolute right-[13px] bottom-[4px] text-[1.2rem] transform -translate-y-1/2'
