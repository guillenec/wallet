  ...
  return (
    <div className='flex w-full h-auto xl:w-[80%] min-h-screen flex-col items-center justify-center bg-fondo pb-5'>
      ...
      <section className='w-full h-auto flex flex-col gap-5 items-center justify-center'>
        <TitulosPages titulo='canal de denuncias' subtitulo='Denuncia sobre: Corrupción, soborno, conflicto de intereses u otros delitos' />
        <div className='h-auto w-full flex flex-col items-center justify-center pt-5 pb-5'>
          {cononModal
            ? (
              <section className='w-full h-[80px] flex items-center justify-center'>
                <p className='text-center text-green-500 font-parrafo font-[500]'>
                  {successMessage}
                </p>
              </section>
              )
